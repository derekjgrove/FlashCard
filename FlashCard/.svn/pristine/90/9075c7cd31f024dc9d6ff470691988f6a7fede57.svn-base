...
/**
 *
 * Main activity of manage. Presents a Listview of results from
 * the list.
 *
 * @since 2015
 ...
 *
 */
public class ChooseLessonManageActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_manage);  //designate layout for output
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        lessonNum = Integer.parseInt(selection);
        ...
        Intent intent = new Intent(this, InitializeQuestionsManageActivity.class);
    ...
    public void onBackPressed() {
        // DO NOTHING!!
        Intent i = new Intent(ChooseLessonManageActivity.this, MenuActivity.class);
        ChooseLessonManageActivity.this.startActivity(i);
    }
