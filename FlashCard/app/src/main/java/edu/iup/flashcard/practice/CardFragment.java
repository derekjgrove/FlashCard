...
public class CardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        int lessonNum = sp.getInt(ChooseDeckActivity.SELECTED_LESSON_KEY_CARD, 0);
        ...
        cardAnswer = (TextView) v.findViewById(R.id.answerText);
        cardAnswer.setText(card.getCorrectAnswer());
